...
export default function SupervisorDprScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', e?.message || 'Failed to submit DPR');
    }
  };
...
const styles = StyleSheet.create({
  ...
  formDate: { ...typography.caption, color: colors.neutral[500], marginBottom: spacing.xl },
  field: { marginBottom: spacing.md },
  list: {
    padding: spacing.lg,
    paddingBottom: spacing['6xl'],
  },
  dprCard: { marginBottom: spacing.sm },
  dprRow: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.md },
  dprIcon: {
    width: 40,
    height: 40,
  ...
  dprInfo: { flex: 1 },
  dprDate: { ...typography.bodySmall, fontFamily: fontFamily.semiBold, color: colors.ink },
  dprMeta: { ...typography.caption, color: colors.primary, marginTop: 2 },
  dprWork: { ...typography.caption, color: colors.neutral[600], marginTop: 4 },
  dprNote: { ...typography.caption, color: colors.neutral[400], fontStyle: 'italic', marginTop: 4 },
  statusBadge: {
